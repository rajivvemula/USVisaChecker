...
//        [When(@"I update physical address to existing address (.*) for Application Index (.*)")]
//        public void WhenIUpdatePhysicalAddressToExistingAddressForApplicationIndex(string existingAddress, int applicationIndex)
//        {
...
//            //update physical address of our object
//            applicationList[applicationIndex].PhysicalAddress = existingAddress;
//        }

//        [Then(@"The Physical Address is successfully updated for Application Index (.*)")]
//        public void ThenThePhysicalAddressIsSuccessfullyUpdatedForApplicationIndex(int applicationIndex)
//        {
//            appMain.busInfoLink.Click();
//            Assert.That(busInfo.GetCurrentPhysicalAddress(), Is.EqualTo(applicationList[applicationIndex].PhysicalAddress), "Physical Address does not match expected.");
//        }
