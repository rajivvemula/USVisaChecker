...
namespace ApolloQA.Features
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("apolloLogin", Description="\tLogin biBerk home page with valid credentials", SourceFile="Features\\BiberkLogin.feature", SourceLine=0)]
