...
namespace ApolloQA.Pages
{
    class Quote_BusinessInformation_Page
    {
        ...
        public static string GetURL(long quoteID, long sectionID) => Quote_Page.GetURL(quoteID, sectionID);
        public static void Navigate(long quoteID, long sectionID) => Quote_Page.Navigate(quoteID, sectionID);
