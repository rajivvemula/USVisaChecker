...
namespace ApolloQA.Pages
{
    ...
    {
        public static Element GridNextButton => new Element("//button[*[contains(text(), 'Next')]]");
        public static Element ExpandAllButton => new Element("//button//*[contains(text(), ' Expand All ')]");
        public static Element ExpandedInfo => new Element("//*[@fxlayoutgap='16px' and @class='ng-star-inserted']");
