...
Scenario:TC2 - Verify existing Organization name display in search result
	When User Navigates to Application Insert 
	When User searches Smoke Test10023 in Business Name
	Then Search Smoke Test10023 displayed is true

Scenario:TC3 - Verify Application Information page and Next should navigate Business Information page
	When User Navigates to Application Insert 
...
Scenario:TC4 - Verify Business Information page sections and fields
	Then Verify organization Smoke Test10023 has correct values in business information

Scenario:TC5 - App Quote - Verify left navigation bar sections
