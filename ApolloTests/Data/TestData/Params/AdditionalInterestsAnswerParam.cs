...
{
    public class AdditionalInterestsAnswerParam : QuentionAnswerParamBase
    {
        //public QuestionAnswer AdditionalInterestContactUpdated { get; set; } = new QuestionAnswer(Alias.AdditionalInterestContactUpdated, "");

        //typeID=3=blanket
        public QuestionAnswer AdditionalInterests { get; set; } = new QuestionAnswer(Alias.AdditionalInterests, "JSON{\"additionalInterestTypeId\":3}");
