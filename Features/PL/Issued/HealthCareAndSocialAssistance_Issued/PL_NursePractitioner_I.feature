Feature: PL_NursePractitioner_I

Issuing a PL Policy using the Nurse Practitioner keyword to verify Your Services new Class Level Questions.
Question: Do you administer or assist with general anesthesia or deep sedation?

@Regression @PL @HealthCare @Issued @ND
Scenario: PL Nurse Practitioner Issued policy in ND
	Given user starts a quote with:
		| Industry           | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Nurse Practitioner | 2         | I Lease a Space From Others |              | 58011    | PL  |
