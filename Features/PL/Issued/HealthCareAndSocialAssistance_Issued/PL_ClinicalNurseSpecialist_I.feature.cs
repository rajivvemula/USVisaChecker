...
namespace ApolloQAAutomation.Features.PL.Issued.HealthCareAndSocialAssistance_Issued
{
    ...
    public partial class PL_ClinicalNurseSpecialist_IFeature
    {
...
#line 1 "PL_ClinicalNurseSpecialist_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/PL/Issued/HealthCareAndSocialAssistance_Issued", "PL_ClinicalNurseSpecialist_I", "Issuing a PL Policy using the Clinical Nurse Specialist keyword to verify Your Se" +
                    "rvices new Class Level Questions.\r\nQuestion: Do you assist with any surgeries or" +
                    " cosmetic procedures?", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "PL_ClinicalNurseSpecialist_I")))
            {
                global::ApolloQAAutomation.Features.PL.Issued.HealthCareAndSocialAssistance_Issued.PL_ClinicalNurseSpecialist_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("PL Clinical Nurse Specialist Issued policy in ND")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "PL_ClinicalNurseSpecialist_I")]
        ...
        public void PLClinicalNurseSpecialistIssuedPolicyInND()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("PL Clinical Nurse Specialist Issued policy in ND", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
            ...
            else
            {
                ...
                table939.AddRow(new string[] {
                            ...
                            "PL"});
#line 8
 testRunner.Given("user starts a quote with:", ((string)(null)), table939, "Given ");
#line hidden
#line 11
...
#line hidden
                ...
                table940.AddRow(new string[] {
                            ...
                            "No"});
#line 12
 testRunner.Then("user fills out A Quick Introduction page with these values:", ((string)(null)), table940, "Then ");
#line hidden
#line 15
...
#line hidden
                ...
                table941.AddRow(new string[] {
                            ...
                            "0"});
#line 16
 testRunner.Then("user fills out the PL Business Details page with these values:", ((string)(null)), table941, "Then ");
#line hidden
#line 21
...
#line hidden
                ...
                table942.AddRow(new string[] {
                            ...
                            "0"});
#line 22
 testRunner.Then("user fills out the PL Coverage Details page with these values:", ((string)(null)), table942, "Then ");
#line hidden
                ...
                table943.AddRow(new string[] {
                            ...
                            "No"});
                table943.AddRow(new string[] {
                            "Do you assist with any surgeries or cosmetic procedures?",
                            "No"});
                table943.AddRow(new string[] {
                ...
                table943.AddRow(new string[] {
                            ...
                            "No"});
#line 29
 testRunner.Then("user fills out the PL Your Services page", ((string)(null)), table943, "Then ");
#line hidden
#line 37
...
#line hidden
                ...
                table944.AddRow(new string[] {
                            ...
                            "No"});
#line 38
 testRunner.Then("user fills out About You page with these values:", ((string)(null)), table944, "Then ");
#line hidden
#line 51
...
#line hidden
                ...
                table945.AddRow(new string[] {
                            ...
                            ""});
#line 54
 testRunner.When("user fills out the PL purchase page with these values:", ((string)(null)), table945, "When ");
#line hidden
#line 65
