Feature: PL_ClinicalNurseSpecialist_I

Issuing a PL Policy using the Clinical Nurse Specialist keyword to verify Your Services new Class Level Questions.
Question: Do you assist with any surgeries or cosmetic procedures?

@Regression @PL @HealthCare @Issued @ND
Scenario: PL Clinical Nurse Specialist Issued policy in ND
	Given user starts a quote with:
		| Industry                  | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Clinical Nurse Specialist | 2         | I Lease a Space From Others |              | 58011    | PL  |
	...
	Then user fills out A Quick Introduction page with these values:
		...
		| Corporation        | Nurse Specialists | Main St          | No  |
	...
	Then user fills out the PL Your Services page
		...
		| Do you assist with any surgeries or cosmetic procedures?                                                                                                                                                                                               | No     |
