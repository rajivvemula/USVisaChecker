Feature: PL_HomeHealthAide_I

Issuing a PL Policy with the Home Health Aide: No Registered Nurses keyword and verified Your Services new Class Level Questions.
Question:  Do you provide health care services or advice that requires a licensed health care professional?

@Regression @PL @HealthCare @Issued @ND
Scenario: PL Home Health Aide: No Registered Nurses Issued policy
	Given user starts a quote with:
		| Industry                               | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Home Health Aide: No Registered Nurses | 2         | I Lease a Space From Others |              | 58011    | PL  |
	...
	Then user fills out A Quick Introduction page with these values:
		...
		| Corporation        | HHA              | 407 Main St      | No  |
