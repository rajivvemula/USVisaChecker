...
namespace ApolloQAAutomation.Features.PL.Issued.HealthCareAndSocialAssistance_Issued
{
    ...
    public partial class PL_NursePractitioner_IFeature
    {
...
#line 1 "PL_NursePractitioner_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/PL/Issued/HealthCareAndSocialAssistance_Issued", "PL_NursePractitioner_I", "Issuing a PL Policy using the Nurse Practitioner keyword to verify Your Services " +
                    "new Class Level Questions.\r\nQuestion: Do you administer or assist with general a" +
                    "nesthesia or deep sedation?", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "PL_NursePractitioner_I")))
            {
                global::ApolloQAAutomation.Features.PL.Issued.HealthCareAndSocialAssistance_Issued.PL_NursePractitioner_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("PL Nurse Practitioner Issued policy in ND")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "PL_NursePractitioner_I")]
        ...
        public void PLNursePractitionerIssuedPolicyInND()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("PL Nurse Practitioner Issued policy in ND", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
            ...
            else
            {
                ...
                table974.AddRow(new string[] {
                            ...
                            "PL"});
#line 8
 testRunner.Given("user starts a quote with:", ((string)(null)), table974, "Given ");
#line hidden
#line 11
...
#line hidden
                ...
                table975.AddRow(new string[] {
                            ...
                            "No"});
#line 12
 testRunner.Then("user fills out A Quick Introduction page with these values:", ((string)(null)), table975, "Then ");
#line hidden
#line 15
...
#line hidden
                ...
                table976.AddRow(new string[] {
                            ...
                            "0"});
#line 16
 testRunner.Then("user fills out the PL Business Details page with these values:", ((string)(null)), table976, "Then ");
#line hidden
#line 21
...
#line hidden
                ...
                table977.AddRow(new string[] {
                            ...
                            "0"});
#line 22
 testRunner.Then("user fills out the PL Coverage Details page with these values:", ((string)(null)), table977, "Then ");
#line hidden
                ...
                table978.AddRow(new string[] {
                            ...
                            "No"});
#line 29
 testRunner.Then("user fills out the PL Your Services page", ((string)(null)), table978, "Then ");
#line hidden
#line 37
...
#line hidden
                ...
                table979.AddRow(new string[] {
                            ...
                            "No"});
#line 38
 testRunner.Then("user fills out About You page with these values:", ((string)(null)), table979, "Then ");
#line hidden
#line 51
...
#line hidden
                ...
                table980.AddRow(new string[] {
                            ...
                            ""});
#line 54
 testRunner.When("user fills out the PL purchase page with these values:", ((string)(null)), table980, "When ");
#line hidden
#line 65
