...
namespace ApolloQAAutomation.Features.PL.Issued.HealthCareAndSocialAssistance_Issued
{
    ...
    public partial class PL_LicensedClinicalSocialWorker_IFeature
    {
...
#line 1 "PL_LicensedClinicalSocialWorker_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/PL/Issued/HealthCareAndSocialAssistance_Issued", "PL_LicensedClinicalSocialWorker_I", "Issuing a PL Policy using the Licensed Clinical Social Worker keyword to verify Y" +
                    "our Services new Class Level Questions.\r\nQuestion: Do any business owner(s) or s" +
                    "taff have a PhD in psychology?", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "PL_LicensedClinicalSocialWorker_I")))
            {
                global::ApolloQAAutomation.Features.PL.Issued.HealthCareAndSocialAssistance_Issued.PL_LicensedClinicalSocialWorker_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("PL Licensed Clinical Social Worker Issued policy in ND")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "PL_LicensedClinicalSocialWorker_I")]
        ...
        public void PLLicensedClinicalSocialWorkerIssuedPolicyInND()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("PL Licensed Clinical Social Worker Issued policy in ND", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
            ...
            else
            {
                ...
                table967.AddRow(new string[] {
                            ...
                            "PL"});
#line 8
 testRunner.Given("user starts a quote with:", ((string)(null)), table967, "Given ");
#line hidden
#line 11
...
#line hidden
                ...
                table968.AddRow(new string[] {
                            ...
                            "No"});
#line 12
 testRunner.Then("user fills out A Quick Introduction page with these values:", ((string)(null)), table968, "Then ");
#line hidden
#line 15
...
#line hidden
                ...
                table969.AddRow(new string[] {
                            ...
                            "0"});
#line 16
 testRunner.Then("user fills out the PL Business Details page with these values:", ((string)(null)), table969, "Then ");
#line hidden
#line 21
...
#line hidden
                ...
                table970.AddRow(new string[] {
                            ...
                            "0"});
#line 22
 testRunner.Then("user fills out the PL Coverage Details page with these values:", ((string)(null)), table970, "Then ");
#line hidden
                ...
                table971.AddRow(new string[] {
                            ...
                            "No"});
                table971.AddRow(new string[] {
                            "Do any business owner(s) or staff have a PhD in psychology?",
                            "No"});
                table971.AddRow(new string[] {
                ...
                table971.AddRow(new string[] {
                            ...
                            "No"});
#line 29
 testRunner.Then("user fills out the PL Your Services page", ((string)(null)), table971, "Then ");
#line hidden
#line 35
...
#line hidden
                ...
                table972.AddRow(new string[] {
                            ...
                            "No"});
#line 36
 testRunner.Then("user fills out About You page with these values:", ((string)(null)), table972, "Then ");
#line hidden
#line 49
...
#line hidden
                ...
                table973.AddRow(new string[] {
                            ...
                            ""});
#line 52
 testRunner.When("user fills out the PL purchase page with these values:", ((string)(null)), table973, "When ");
#line hidden
#line 63
