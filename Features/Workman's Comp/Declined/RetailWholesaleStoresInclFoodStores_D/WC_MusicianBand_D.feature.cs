...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Workman\'s Comp/Declined/RetailWholesaleStoresInclFoodStores_D", "WC_MusicianBand_D", @"Ineligible Quote for the 
Keyword: Pawn shop
...
Business started year : Started 8 years ago", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            ...
            {
                global::BiBerkLOB.Features.WorkmansComp.Declined.RetailWholesaleStoresInclFoodStores_D.WC_MusicianBand_DFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("WC_MusicianBand_D gets declined because want insurance to cover volunteers")]
        ...
        public void WC_MusicianBand_DGetsDeclinedBecauseWantInsuranceToCoverVolunteers()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WC_MusicianBand_D gets declined because want insurance to cover volunteers", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 13
...
#line hidden
                ...
                table1372.AddRow(new string[] {
                            ...
                            "www.GoldandPawn.com"});
#line 18
 testRunner.Then("user fills out the WC About You page with these values:", ((string)(null)), table1372, "Then ");
#line hidden
#line 35
...
#line hidden
                ...
                table1373.AddRow(new string[] {
                            ...
                            "1"});
#line 36
 testRunner.Then("user handles the WC OO kickoff questions with these values:", ((string)(null)), table1373, "Then ");
#line hidden
...
#line 39
 testRunner.Then("user handles the WC Covered OO with these values:", ((string)(null)), table1374, "Then ");
#line hidden
#line 42
...
#line hidden
                ...
                table1375.AddRow(new string[] {
                            ...
                            "no"});
#line 44
 testRunner.Then("user fills out the WC Your Services page", ((string)(null)), table1375, "Then ");
#line hidden
#line 57
