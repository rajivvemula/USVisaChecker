...
namespace ApolloQAAutomation.Features.WorkmansComp.Issued.Manufacturing_I
{
    ...
    public partial class WC_AwningsManufacturing_IFeature
    {
...
#line 1 "WC_AwningsManufacturing_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Workman\'s Comp/Issued/Manufacturing_I", "WC_AwningsManufacturing_I", "Issuing policy for Manufacturing: Awnings Manufacturing\r\nzip code: 63010", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "WC_AwningsManufacturing_I")))
            {
                global::ApolloQAAutomation.Features.WorkmansComp.Issued.Manufacturing_I.WC_AwningsManufacturing_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("WC Awnings Manufacturing creates issued policy in Missouri")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "WC_AwningsManufacturing_I")]
        ...
        public void WCAwningsManufacturingCreatesIssuedPolicyInMissouri()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WC Awnings Manufacturing creates issued policy in Missouri", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
            ...
            else
            {
                ...
                table2345.AddRow(new string[] {
                            "Awnings Manufacturing: No Installation",
                            "5",
                            ...
                            "WC"});
#line 8
 testRunner.Given("user starts a quote with:", ((string)(null)), table2345, "Given ");
#line hidden
#line 11
...
#line hidden
                ...
                table2346.AddRow(new string[] {
                            "Address",
                            "130 Arnold Crossroads Center;Arnold"});
                table2346.AddRow(new string[] {
                            "Fill Contact",
                            ""});
#line 12
 testRunner.Then("user fills out the WC About You page with these values:", ((string)(null)), table2346, "Then ");
#line hidden
#line 22
...
#line hidden
                ...
                table2347.AddRow(new string[] {
                            ...
                            "0"});
#line 23
 testRunner.Then("user handles the WC OO kickoff questions with these values:", ((string)(null)), table2347, "Then ");
#line hidden
#line 27
...
#line hidden
                ...
                table2348.AddRow(new string[] {
                            ...
                            "no"});
                table2348.AddRow(new string[] {
                            "Do you do (or arrange for subcontractors to do) any installation services for you" +
                                "r customers?",
                            "no"});
                table2348.AddRow(new string[] {
                ...
                table2348.AddRow(new string[] {
                            ...
                            "no"});
#line 29
 testRunner.Then("user fills out the WC Your Services page", ((string)(null)), table2348, "Then ");
#line hidden
#line 38
...
#line 41
 testRunner.When("user selects a standard single-bundle plan quote with the following customization" +
                        "s from the WC your quote page:", ((string)(null)), table2349, "When ");
#line hidden
#line 44
...
#line hidden
                ...
                table2350.AddRow(new string[] {
                            "NameC NameD"});
#line 45
 testRunner.Then("wc user handles 2 excluded oo with these values:", ((string)(null)), table2350, "Then ");
#line hidden
#line 49
...
#line hidden
                ...
                table2351.AddRow(new string[] {
                            ...
                            "Yes"});
#line 50
 testRunner.Then("user fills out the WC purchase page with these values:", ((string)(null)), table2351, "Then ");
#line hidden
#line 63
