Feature: WC_PrivatePatrolAgency_I

Issuing a Private Patrol Agency policy

@Service @WC @Issued @AL @Regression @YourServices
Scenario: WC Private Patrol Agency issuing a policy for Alabama
	Given user starts a quote with:
		| Industry              | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Private Patrol Agency | 3         | I Lease a Space From Others |              | 36532    | WC  |
	...
	Then user fills out the WC About You page with these values:
		...
		| Business                                                                               | Paw Patrol Agency;PPA     |
		| Address                                                                                | 112 N Bayview St;Fairhope |
		| Fill Contact                                                                           |                           |
	...
	Then user fills out the WC Your Services page
		| Question                                                                                 | Answer     |
		| Do you engage in auto repossession, bounty hunting, or bail bond recovery?               | no         |
		| Do any security personnel carry defensive equipment such as firearms, tasers, or batons? | no         |
