Feature: WC_ConstructionSpecialty_Drywall_I

Issuing a WC Construction Specialty Drywall Issued Policy

@Service @WC @Issued @MS @Regression @YourServices
Scenario: WC Construction: Specialty Drywall policy issued for Mississippi
	Given user starts a quote with:
		| Industry                         | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Construction: Specialty; Drywall | 3         | I Lease a Space From Others |              | 39503    | WC  |
