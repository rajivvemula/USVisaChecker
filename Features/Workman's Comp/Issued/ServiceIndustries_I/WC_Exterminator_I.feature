Feature: WC_Exterminator_I

Workman's Comp Exterminator Issued Policy In Florida

@Service @WC @Issued @FL @Regression @YourServices
Scenario: WC Exterminator Issued In Florida
	Given user starts a quote with:
		| Industry     | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Exterminator | 3         | I Lease a Space From Others |              | 33062    | WC  |
	...
	Then user fills out the WC About You page with these values:
		...
		| Business                                                                               | Extermin8 Events LLC;CE       |
		| Address                                                                                | 235 NE 24th Ave;Pompano Beach |
		| Fill Contact                                                                           |                               |
	...
	Then user fills out the WC Your Services page
		| Question                                                                  | Answer     |
		| Do you have a pest control license?                                       | yes        |
