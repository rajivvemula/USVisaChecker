...
namespace ApolloQAAutomation.Features.WorkmansComp.Issued.ServiceIndustries_I
{
    ...
    public partial class WC_CCTVInstallationOrRepair_IssuedFeature
    {
...
#line 1 "WC_CCTVInstallationOrRepair_Issued.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Workman\'s Comp/Issued/ServiceIndustries_I", "WC_CCTVInstallationOrRepair_Issued", "WC CCTV Installation Or Repair Issued In Colorado", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "WC_CCTVInstallationOrRepair_Issued")))
            {
                global::ApolloQAAutomation.Features.WorkmansComp.Issued.ServiceIndustries_I.WC_CCTVInstallationOrRepair_IssuedFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("WC CCTV Installation Or Repair Issued In Colorado")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "WC_CCTVInstallationOrRepair_Issued")]
        ...
        public void WCCCTVInstallationOrRepairIssuedInColorado()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WC CCTV Installation Or Repair Issued In Colorado", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table2677.AddRow(new string[] {
                            ...
                            "WC"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table2677, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table2678.AddRow(new string[] {
                            "Address",
                            "1940 13th St;Penrose"});
                table2678.AddRow(new string[] {
                            "Fill Contact",
                            ""});
#line 11
 testRunner.Then("user fills out the WC About You page with these values:", ((string)(null)), table2678, "Then ");
#line hidden
#line 23
...
#line hidden
                ...
                table2679.AddRow(new string[] {
                            ...
                            "0"});
#line 24
 testRunner.Then("user handles the WC OO kickoff questions with these values:", ((string)(null)), table2679, "Then ");
#line hidden
#line 28
...
#line hidden
                ...
                table2680.AddRow(new string[] {
                            ...
                            "no"});
                table2680.AddRow(new string[] {
                            "Do you perform any work on chemical and/or foam sprinklers?",
                            "no"});
                table2680.AddRow(new string[] {
                ...
                table2680.AddRow(new string[] {
                            ...
                            "no"});
#line 29
 testRunner.Then("user fills out the WC Your Services page", ((string)(null)), table2680, "Then ");
#line hidden
#line 38
...
#line 41
 testRunner.When("user selects a standard single-bundle plan quote with the following customization" +
                        "s from the WC your quote page:", ((string)(null)), table2681, "When ");
#line hidden
#line 44
 testRunner.Then("user begins the WC AI page setting the FEIN with value 23-1963595", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
                ...
                table2682.AddRow(new string[] {
                            "Vera Angel"});
#line 45
 testRunner.Then("wc user handles 1 excluded oo with these values:", ((string)(null)), table2682, "Then ");
#line hidden
#line 48
...
#line hidden
                ...
                table2683.AddRow(new string[] {
                            ...
                            "Yes"});
#line 49
 testRunner.Then("user fills out the WC purchase page with these values:", ((string)(null)), table2683, "Then ");
#line hidden
#line 62
