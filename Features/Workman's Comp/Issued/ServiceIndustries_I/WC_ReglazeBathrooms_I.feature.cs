...
namespace ApolloQAAutomation.Features.WorkmansComp.Issued.ServiceIndustries_I
{
    ...
    public partial class WC_ReglazeBathrooms_IFeature
    {
...
#line 1 "WC_ReglazeBathrooms_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Workman\'s Comp/Issued/ServiceIndustries_I", "WC_ReglazeBathrooms_I", "Issuing a WC Reglaze Bathrooms Issued Policy", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "WC_ReglazeBathrooms_I")))
            {
                global::ApolloQAAutomation.Features.WorkmansComp.Issued.ServiceIndustries_I.WC_ReglazeBathrooms_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("WC Reglaze Bathrooms policy issued for PA")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "WC_ReglazeBathrooms_I")]
        ...
        public void WCReglazeBathroomsPolicyIssuedForPA()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WC Reglaze Bathrooms policy issued for PA", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table2813.AddRow(new string[] {
                            ...
                            "WC"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table2813, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table2814.AddRow(new string[] {
                            "Business",
                            "Reglaze Bathrooms LLC;CE"});
                table2814.AddRow(new string[] {
                            "Address",
                            "450A Main St;Callensburg"});
                table2814.AddRow(new string[] {
                            "Fill Contact",
                            ""});
#line 11
 testRunner.Then("user fills out the WC About You page with these values:", ((string)(null)), table2814, "Then ");
#line hidden
#line 22
...
#line hidden
                ...
                table2815.AddRow(new string[] {
                            ...
                            "0"});
#line 23
 testRunner.Then("user handles the WC OO kickoff questions with these values:", ((string)(null)), table2815, "Then ");
#line hidden
#line 27
...
#line hidden
                ...
                table2816.AddRow(new string[] {
                            ...
                            "no"});
                table2816.AddRow(new string[] {
                            "What percentage of work done is drywall or sheetrock installation or repair?",
                            "1-25%"});
                table2816.AddRow(new string[] {
                ...
                table2816.AddRow(new string[] {
                            ...
                            "23-1326965"});
#line 28
 testRunner.Then("user fills out the WC Your Services page", ((string)(null)), table2816, "Then ");
#line hidden
#line 44
...
#line 47
 testRunner.When("user selects a standard single-bundle plan quote with the following customization" +
                        "s from the WC your quote page:", ((string)(null)), table2817, "When ");
#line hidden
#line 50
...
#line hidden
                ...
                table2818.AddRow(new string[] {
                            "Vera Angel"});
#line 51
 testRunner.Then("wc user handles 1 excluded oo with these values:", ((string)(null)), table2818, "Then ");
#line hidden
#line 54
...
#line hidden
                ...
                table2819.AddRow(new string[] {
                            ...
                            "Yes"});
#line 55
 testRunner.Then("user fills out the WC purchase page with these values:", ((string)(null)), table2819, "Then ");
#line hidden
#line 68
