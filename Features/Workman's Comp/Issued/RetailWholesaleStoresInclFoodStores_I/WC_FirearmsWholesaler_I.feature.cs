...
namespace ApolloQAAutomation.Features.WorkmansComp.Issued.RetailWholesaleStoresInclFoodStores_I
{
    ...
    public partial class WC_FirearmsWholesaler_IFeature
    {
...
#line 1 "WC_FirearmsWholesaler_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Workman\'s Comp/Issued/RetailWholesaleStoresInclFoodStores_I", "WC_FirearmsWholesaler_I", "Issuing a Firearms Wholesaler - New Mexico Issued Policy ", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "WC_FirearmsWholesaler_I")))
            {
                global::ApolloQAAutomation.Features.WorkmansComp.Issued.RetailWholesaleStoresInclFoodStores_I.WC_FirearmsWholesaler_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("WC Firearms Wholesaler issued in New Mexico")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "WC_FirearmsWholesaler_I")]
        ...
        public void WCFirearmsWholesalerIssuedInNewMexico()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WC Firearms Wholesaler issued in New Mexico", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
...
#line hidden
            ...
            else
            {
                ...
                table2508.AddRow(new string[] {
                            ...
                            "WC"});
#line 6
 testRunner.Given("user starts a quote with:", ((string)(null)), table2508, "Given ");
#line hidden
#line 9
...
#line hidden
                ...
                table2509.AddRow(new string[] {
                            "Address",
                            "128 Steese Hwy;Santa Fe"});
                table2509.AddRow(new string[] {
                            "Fill Contact",
                            ""});
#line 10
 testRunner.Then("user fills out the WC About You page with these values:", ((string)(null)), table2509, "Then ");
#line hidden
#line 19
...
#line hidden
                ...
                table2510.AddRow(new string[] {
                            ...
                            "0"});
#line 20
 testRunner.Then("user handles the WC OO kickoff questions with these values:", ((string)(null)), table2510, "Then ");
#line hidden
#line 24
...
#line hidden
                ...
                table2511.AddRow(new string[] {
                            ...
                            "None"});
                table2511.AddRow(new string[] {
                            "Do you operate a shooting or firing range where live ammunition is used?",
                            "yes"});
                table2511.AddRow(new string[] {
                ...
                table2511.AddRow(new string[] {
                            ...
                            "no"});
#line 25
 testRunner.Then("user fills out the WC Your Services page", ((string)(null)), table2511, "Then ");
#line hidden
#line 32
...
#line 35
 testRunner.When("user selects a standard single-bundle plan quote with the following customization" +
                        "s from the WC your quote page:", ((string)(null)), table2512, "When ");
#line hidden
#line 38
...
#line hidden
                ...
                table2513.AddRow(new string[] {
                            "Selina Joseph"});
#line 39
 testRunner.Then("wc user handles 1 excluded oo with these values:", ((string)(null)), table2513, "Then ");
#line hidden
#line 42
...
#line hidden
                ...
                table2514.AddRow(new string[] {
                            ...
                            "Yes"});
#line 43
 testRunner.Then("user fills out the WC purchase page with these values:", ((string)(null)), table2514, "Then ");
#line hidden
#line 56
