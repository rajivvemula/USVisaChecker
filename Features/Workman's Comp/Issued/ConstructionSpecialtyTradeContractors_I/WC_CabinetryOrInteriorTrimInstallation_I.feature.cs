...
namespace ApolloQAAutomation.Features.WorkmansComp.Issued.ConstructionSpecialtyTradeContractors_I
{
    ...
    public partial class WC_CabinetryOrInteriorTrimInstallation_IFeature
    {
...
#line 1 "WC_CabinetryOrInteriorTrimInstallation_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Workman\'s Comp/Issued/ConstructionSpecialtyTradeContractors_I", "WC_CabinetryOrInteriorTrimInstallation_I", "CabinetryOrInteriorTrimInstallation Auto XMODs", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "WC_CabinetryOrInteriorTrimInstallation_I")))
            {
                global::ApolloQAAutomation.Features.WorkmansComp.Issued.ConstructionSpecialtyTradeContractors_I.WC_CabinetryOrInteriorTrimInstallation_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("WC Cabinetry Or Interior Trim Installation policy issued for Arizona/ Auto XMODs")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "WC_CabinetryOrInteriorTrimInstallation_I")]
        ...
        public void WCCabinetryOrInteriorTrimInstallationPolicyIssuedForArizonaAutoXMODs()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WC Cabinetry Or Interior Trim Installation policy issued for Arizona/ Auto XMODs", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table2006.AddRow(new string[] {
                            "Cabinetry or Interior Trim Installation",
                            "5",
                            ...
                            "WC"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table2006, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table2007.AddRow(new string[] {
                            "Business",
                            "Test Auto XMOD; Test DBA"});
                table2007.AddRow(new string[] {
                            "Address",
                            "2104 E Firestone Dr;Chandler"});
                table2007.AddRow(new string[] {
                            "Contact First Name",
                            "TestF"});
                table2007.AddRow(new string[] {
                ...
                table2007.AddRow(new string[] {
                            ...
                            "test.com"});
#line 11
 testRunner.Then("user fills out the WC About You page with these values:", ((string)(null)), table2007, "Then ");
#line hidden
#line 26
...
#line hidden
                ...
                table2008.AddRow(new string[] {
                            ...
                            "0"});
#line 27
 testRunner.Then("user handles the WC OO kickoff questions with these values:", ((string)(null)), table2008, "Then ");
#line hidden
                ...
                table2009.AddRow(new string[] {
                            ...
                            "TestL"});
#line 31
 testRunner.Then("user handles the WC Excluded OO with these values:", ((string)(null)), table2009, "Then ");
#line hidden
#line 34
...
#line hidden
                ...
                table2010.AddRow(new string[] {
                            ...
                            "06-2671064"});
#line 35
 testRunner.Then("user fills out the WC Your Services page", ((string)(null)), table2010, "Then ");
#line hidden
#line 50
...
#line 53
 testRunner.When("user selects a Standard Single-Bundle plan quote with the following customization" +
                        "s from the WC your quote page:", ((string)(null)), table2011, "When ");
#line hidden
#line 56
...
#line hidden
                ...
                table2012.AddRow(new string[] {
                            ""});
#line 57
 testRunner.Then("wc user handles 1 excluded oo with these values:", ((string)(null)), table2012, "Then ");
#line hidden
#line 60
...
#line hidden
                ...
                table2013.AddRow(new string[] {
                            ...
                            "Yes"});
#line 61
 testRunner.Then("user fills out the WC purchase page with these values:", ((string)(null)), table2013, "Then ");
#line hidden
#line 73
