Feature: WC_WomenShelter_I
Issuing policy for Women Shelter
zipcode: 84501

@Health @Regression @WC @Issued @UT @YourServices
Scenario: WC Women Shelter creates issued policy in Utah
	Given user starts a quote with:
		| Industry      | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Women Shelter | 8         | I Lease a Space From Others |              | 84501    | WC  |
	...
	Then user fills out the WC About You page with these values:
		...
		| What is the total annual payroll for W-2 employees? (exclude business owners/officers)    | 70400                       |
		| Do any employees only do general office work and would never interact with any residents? | no                          |
		| Business                                                                                  | Utah Women Shelter          |
		| Address                                                                                   | 149 E 100 S;Price           |
		| Fill Contact                                                                              |                             |
	...
	Then user fills out the WC Your Services page
		| Question                                                                                               | Answer                                       |
		| Do you accept clients that have been diagnosed with a form of dementia?                                | Yes - a few of our clients may have dementia |
		...
		| What percentage of residents or clients are ambulatory?                                                | 15                                           |
