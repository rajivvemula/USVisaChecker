Feature: WC_ArtTherapist_I

Issued Art Therapist Policy

 @Regression @WC @Issued @Health @Regression @YourServices @MN 
Scenario: WC Art Therapist creates issued policy in Minnesota
	Given user starts a quote with:
		| Industry      | Employees | Location                           | Own or Lease | ZIP Code | LOB |
		| Art Therapist | 8         | I Own a Property & Lease to Others |              | 55406    | WC  |
	...
	Then user fills out the WC Your Services page
		...
		| Do you offer any inpatient services?                                                                   | no          |
