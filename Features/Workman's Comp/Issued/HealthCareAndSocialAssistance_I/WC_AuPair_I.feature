...
WC Issued Policy For AuPair Keyword

@WC @Regression @Health @Issued @YourServices @TX
Scenario: WC Au Pair Issued Policy In Texas
	Given user starts a quote with:
		| Industry | Employees | Location                    | Own or Lease | ZIP Code | LOB |
		| Au Pair  | 7         | I Lease a Space From Others |              | 78712    | WC  |
	...
	Then user fills out the WC About You page with these values:
		...
		| Business                               | International Child Care;International Child Services |
		| Address                                | 2515 Speedway;Austin                                  |
		| Fill Contact                           |                                                       |
	...
	Then user fills out the WC Your Services page
		...
		| Do any workers perform property maintenance or landscaping duties?                                     | no         |
