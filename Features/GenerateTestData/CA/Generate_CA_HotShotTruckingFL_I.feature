Feature: Generate_CA_HotShotTruckingFL_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Hot Shot Trucking successfully purchases a policy for FL
	Given user starts a quote with:
		| Industry          | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Hot Shot Trucking | 2         | I Run My Business From Property I Own | Vehicles     | 32506    | CA  |
	...
	And user fills in the Introduction page with these values:
		...
		| 1900                  | Individual/Sole Proprietor | 8423 Kause Rd |          | Pensacola |                   | Yes             |
	...
	And user creates a vehicle or trailer with variable values:
		...
		| 5NMZU3LB2JH065041 | Florida         | 10000         |
	Then user adds another vehicle or trailer
	And user creates a vehicle or trailer with variable values:
		| VIN               | Parking Address | Vehicle Worth |
		| 1FTNE2EW0DDA17671 | Florida         | 10000         |
	Then user clicks Let's Continue
	Then User verifies appearance of the Drivers Page
	And user creates a driver with these values:
		| FirstName | LastName | DLState | DOB        | CDL                  | ILDDC | ILViolation | ILDLRevoked | Accident | DLNumber      |
		| Chris     | Rock     | FL      | 03/13/1986 | Yes less than 1 year |       |             |             | No       | A000214398765 |
		| Eric      | Smith    | FL      | 04/01/1988 | Yes less than 1 year |       |             |             | No       | A000214398763 |
		| Mike      | Jones    | FL      | 09/03/1989 | Yes less than 1 year |       |             |             | No       | A000214398762 |
	...
	And user enters contact information:
		...
		| Owner's Address                 | 8423 Kause Rd       |
		| Owner's Address 2               |                     |
		| Owner's Zip Code                | 32506               |
		| Owner's City                    | Pensacola           |
