Feature: Generate_CA_MechanicalEngineering_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Mechanical Engineering successfully purchases a policy for Cali
	Given user starts a quote with:
		| Industry               | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Mechanical Engineering | 2         | I Run My Business From Property I Own | Vehicles     | 95135    | CA  |
	...
	And user creates a vehicle or trailer with variable values:
		...
		| 3D3KR19D97G838924 | California      | 12000         |
	...
	And user creates a driver with these values:
		...
		| Chris     | Rock     | CA      | 03/13/1986 |     |       |             |             | No       | A0002147 |
		| Eric      | Smith    | CA      | 04/01/1988 |     |       |             |             | No       | A0003144 |
		| Mike      | Jones    | CA      | 09/03/1989 |     |       |             |             | No       | A0002168 |
	...
	And user enters contact information:
		...
		| First Name                      | John                |
		| Last Name                       | Jones               |
		| Business Email                  | ASDASDF@yopmail.com |
