Feature: Generate_CA_ComputerHardwareEngineer_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Computer Hardware Engineer successfully purchases a policy for TX
	Given user starts a quote with:
		| Industry                      | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Computer Hardware Engineering | 2         | I Run My Business From Property I Own | Vehicles     | 78734    | CA  |
	...
	And user enters contact information:
		...
		| First Name                      | Eric                        |
		| Last Name                       | Andre                       |
		| Business Email                  | CompRepair@yopmail.com      |
