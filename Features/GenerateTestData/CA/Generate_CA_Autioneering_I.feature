Feature: Generate_CA_Auctioneering_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA @CLADHOC1
Scenario: Generate CA Auctioneering successfully purchases a policy for FL
	Given user starts a quote with:
		| Industry      | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Auctioneering | 2         | I Run My Business From Property I Own | Vehicles     | 32541    | CA  |
	...
	And user creates a driver with these values:
		...
		| Chris     | Rock     | FL      | 03/13/1986 |     |       |             |             | No       | A000214398765 |
		| Eric      | Smith    | FL      | 04/01/1988 |     |       |             |             | No       | A000214398763 |
		| Mike      | Jones    | FL      | 09/03/1989 |     |       |             |             | No       | A000214398762 |
	...
	And user enters contact information:
		...
		| First Name                      | Ariana                    |
		| Last Name                       | Grande                    |
		| Business Email                  | Auctioneering@yopmail.com |
