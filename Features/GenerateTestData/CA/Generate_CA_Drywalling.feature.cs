...
namespace ApolloQAAutomation.Features.GenerateTestData.CA
{
    ...
    public partial class Generate_CA_Drywalling_IFeature
    {
...
#line 1 "Generate_CA_Drywalling.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/GenerateTestData/CA", "Generate_CA_Drywalling_I", "Populate the system with testing data primarily base on most common policy types " +
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Generate_CA_Drywalling_I")))
            {
                global::ApolloQAAutomation.Features.GenerateTestData.CA.Generate_CA_Drywalling_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Generate CA Drywalling successfully purchases a policy for TX")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Generate_CA_Drywalling_I")]
        ...
        public void GenerateCADrywallingSuccessfullyPurchasesAPolicyForTX()
        {
            string[] tagsOfScenario = new string[] {
                    "Generate",
                    "CA"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Generate CA Drywalling successfully purchases a policy for TX", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table666.AddRow(new string[] {
                            ...
                            "CA"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table666, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table667.AddRow(new string[] {
                            ...
                            ""});
#line 11
 testRunner.Then("user fills in the Start Your Quote page with these values:", ((string)(null)), table667, "Then ");
#line hidden
#line 17
...
#line hidden
                ...
                table668.AddRow(new string[] {
                            ...
                            "Yes"});
#line 19
 testRunner.And("user fills in the Introduction page with these values:", ((string)(null)), table668, "And ");
#line hidden
#line 22
...
#line hidden
                ...
                table669.AddRow(new string[] {
                            ...
                            "No"});
#line 24
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table669, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table671.AddRow(new string[] {
                            ...
                            "No"});
#line 32
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table671, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table672.AddRow(new string[] {
                            ...
                            "F355321654736"});
#line 37
 testRunner.And("user creates a driver with these values:", ((string)(null)), table672, "And ");
#line hidden
#line 42
...
#line hidden
                ...
                table673.AddRow(new string[] {
                            ...
                            "0"});
#line 43
 testRunner.Then("user fills out the Operations page:", ((string)(null)), table673, "Then ");
#line hidden
#line 47
...
#line hidden
                ...
                table674.AddRow(new string[] {
                            ...
                            "Florida"});
#line 49
 testRunner.And("user enters contact information:", ((string)(null)), table674, "And ");
#line hidden
#line 65
...
#line 67
 testRunner.And("user completes their Quote", ((string)(null)), table675, "And ");
#line hidden
#line 71
...
#line hidden
                ...
                table676.AddRow(new string[] {
                            ...
                            "Myself"});
#line 73
 testRunner.And("user fills out the Additional Information page:", ((string)(null)), table676, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table677.AddRow(new string[] {
                            ...
                            "Visa"});
#line 79
 testRunner.Then("user goes to purchase a plan using the following information:", ((string)(null)), table677, "Then ");
#line hidden
#line 82
