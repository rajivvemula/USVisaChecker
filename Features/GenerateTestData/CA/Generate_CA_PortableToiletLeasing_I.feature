Feature: Generate_CA_PortableToiletLeasing_I

@Generate @CA
Scenario: Generate_CA_PortableToiletLeasing_I successfully purchases a policy for Cali
	Given user starts a quote with:
		| Industry                | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Portable Toilet Leasing | 2         | I Run My Business From Property I Own | Vehicles     | 94558    | CA  |
	...
	And user creates a vehicle or trailer with variable values:
		...
		| 5NMZU3LB2JH065041 | California      | No           |
	Then user adds another vehicle or trailer
	And user creates a vehicle or trailer with variable values:
		| VIN               | Parking Address | Vehicle Worth | Plowing Snow |
		| 1FTNE2EW0DDA17671 | California      | 10000         | No           |
	...
	And user enters contact information:
		...
		| First Name                      | Ariana               |
		| Last Name                       | Grande               |
		| Business Email                  | PortaPro@yopmail.com |
