Feature: Generate_CA_DeckRepair_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate_CA_DeckRepair_I successfully purchases a policy for TX
	Given user starts a quote with:
		| Industry    | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Deck Repair | 2         | I Run My Business From Property I Own | Vehicles     | 78734    | CA  |
	...
	And user enters contact information:
		...
		| First Name                      | Ariana                      |
		| Last Name                       | Grande                      |
		| Business Email                  | DeckRepair@yopmail.com      |
