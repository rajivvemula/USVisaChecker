...
namespace ApolloQAAutomation.Features.GenerateTestData.CA
{
    ...
    public partial class Generate_CA_DeckRepair_IFeature
    {
...
#line 1 "Generate_CA_DeckRepair_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/GenerateTestData/CA", "Generate_CA_DeckRepair_I", "Populate the system with testing data primarily base on most common policy types " +
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Generate_CA_DeckRepair_I")))
            {
                global::ApolloQAAutomation.Features.GenerateTestData.CA.Generate_CA_DeckRepair_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Generate_CA_DeckRepair_I successfully purchases a policy for TX")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Generate_CA_DeckRepair_I")]
        ...
        public void Generate_CA_DeckRepair_ISuccessfullyPurchasesAPolicyForTX()
        {
            string[] tagsOfScenario = new string[] {
                    "Generate",
                    "CA"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Generate_CA_DeckRepair_I successfully purchases a policy for TX", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table630.AddRow(new string[] {
                            ...
                            "CA"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table630, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table631.AddRow(new string[] {
                            ...
                            ""});
#line 11
 testRunner.Then("user fills in the Start Your Quote page with these values:", ((string)(null)), table631, "Then ");
#line hidden
#line 17
...
#line hidden
                ...
                table632.AddRow(new string[] {
                            ...
                            "Yes"});
#line 19
 testRunner.And("user fills in the Introduction page with these values:", ((string)(null)), table632, "And ");
#line hidden
#line 22
...
#line hidden
                ...
                table633.AddRow(new string[] {
                            ...
                            "No"});
#line 24
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table633, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table635.AddRow(new string[] {
                            ...
                            "No"});
#line 32
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table635, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table636.AddRow(new string[] {
                            ...
                            "32165473"});
#line 37
 testRunner.And("user creates a driver with these values:", ((string)(null)), table636, "And ");
#line hidden
#line 42
...
#line hidden
                ...
                table637.AddRow(new string[] {
                            ...
                            "0"});
#line 43
 testRunner.Then("user fills out the Operations page:", ((string)(null)), table637, "Then ");
#line hidden
#line 47
...
#line hidden
                ...
                table638.AddRow(new string[] {
                            ...
                            "Texas"});
#line 49
 testRunner.And("user enters contact information:", ((string)(null)), table638, "And ");
#line hidden
#line 65
...
#line 67
 testRunner.And("user completes their Quote", ((string)(null)), table639, "And ");
#line hidden
#line 71
...
#line hidden
                ...
                table640.AddRow(new string[] {
                            ...
                            "Myself"});
#line 73
 testRunner.And("user fills out the Additional Information page:", ((string)(null)), table640, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table641.AddRow(new string[] {
                            ...
                            "Visa"});
#line 79
 testRunner.Then("user goes to purchase a plan using the following information:", ((string)(null)), table641, "Then ");
#line hidden
#line 82
