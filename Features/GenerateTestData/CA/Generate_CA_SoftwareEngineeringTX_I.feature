Feature: Generate_CA_SoftwareEngineeringTX_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Software Engineering successfully purchases a policy for TX
	Given user starts a quote with:
		| Industry             | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Software Engineering | 2         | I Run My Business From Property I Own | Vehicles     | 78744    | CA  |
