Feature: Generate_CA_VentureCapital_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Venture Capital successfully purchases a policy for GA
	Given user starts a quote with:
		| Industry        | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Venture Capital | 2         | I Run My Business From Property I Own | Vehicles     | 30331    | CA  |
