Feature: Generate_CA_LimousineCompany_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Limousine Company purchases a policy for GA
	Given user starts a quote with:
		| Industry          | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Limousine Company | 2         | I Run My Business From Property I Own | Vehicles     | 31419    | CA  |
	...
	And user fills in the Introduction page with these values:
		...
		| 1900                  | Individual/Sole Proprietor | 321 Tanglewood Rd |          | Savannah |                   | Yes             |
	...
	And user creates a driver with these values:
		...
		| Chris     | Rock     | GA      | 03/13/1986 |     |       |             |             | No       | 214398765 |
		| Eric      | Smith    | GA      | 04/01/1988 |     |       |             |             | No       | 214398763 |
		| Mike      | Jones    | GA      | 09/03/1989 |     |       |             |             | No       | 214398762 |
	...
	Then user fills out the Operations page:
		...
		| Do you have or plan on applying for an operating authority from the Georgia Department of Public Safety? | No                              |
	...
	And user enters contact information:
		...
		| First Name                      | Lawrence               |
		| Last Name                       | Michaels               |
		| Business Email                  | Bizniz@yopmail.com     |
		...
		| Owner's Address                 | 321 Tanglewood Rd      |
		| Owner's Address 2               |                        |
		| Owner's Zip Code                | 31419                  |
		| Owner's City                    | Savannah               |
