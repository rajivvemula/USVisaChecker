...
namespace ApolloQAAutomation.Features.GenerateTestData.CA
{
    ...
    public partial class Generate_CA_LimousineCompany_IFeature
    {
...
#line 1 "Generate_CA_LimousineCompany_I.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/GenerateTestData/CA", "Generate_CA_LimousineCompany_I", "Populate the system with testing data primarily base on most common policy types " +
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Generate_CA_LimousineCompany_I")))
            {
                global::ApolloQAAutomation.Features.GenerateTestData.CA.Generate_CA_LimousineCompany_IFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Generate CA Limousine Company purchases a policy for GA")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Generate_CA_LimousineCompany_I")]
        ...
        public void GenerateCALimousineCompanyPurchasesAPolicyForGA()
        {
            string[] tagsOfScenario = new string[] {
                    "Generate",
                    "CA"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Generate CA Limousine Company purchases a policy for GA", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table762.AddRow(new string[] {
                            ...
                            "CA"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table762, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table763.AddRow(new string[] {
                            ...
                            ""});
#line 11
 testRunner.Then("user fills in the Start Your Quote page with these values:", ((string)(null)), table763, "Then ");
#line hidden
#line 17
...
#line hidden
                ...
                table764.AddRow(new string[] {
                            ...
                            "Yes"});
#line 19
 testRunner.And("user fills in the Introduction page with these values:", ((string)(null)), table764, "And ");
#line hidden
#line 22
...
#line hidden
                ...
                table765.AddRow(new string[] {
                            ...
                            "12000"});
#line 24
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table765, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table766.AddRow(new string[] {
                            ...
                            "Georgia"});
#line 28
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table766, "And ");
#line hidden
#line 31
 testRunner.Then("user adds another vehicle or trailer", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
                ...
                table767.AddRow(new string[] {
                            ...
                            "10000"});
#line 32
 testRunner.And("user creates a vehicle or trailer with variable values:", ((string)(null)), table767, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table768.AddRow(new string[] {
                            ...
                            "214398762"});
#line 37
 testRunner.And("user creates a driver with these values:", ((string)(null)), table768, "And ");
#line hidden
#line 42
...
#line hidden
                ...
                table769.AddRow(new string[] {
                            ...
                            "50 miles or less"});
                table769.AddRow(new string[] {
                            "Do you have or plan on applying for an operating authority from the Georgia Depar" +
                ...
                table769.AddRow(new string[] {
                            ...
                            "No"});
#line 43
 testRunner.Then("user fills out the Operations page:", ((string)(null)), table769, "Then ");
#line hidden
#line 54
...
#line hidden
                ...
                table770.AddRow(new string[] {
                            ...
                            "Georgia"});
#line 56
 testRunner.And("user enters contact information:", ((string)(null)), table770, "And ");
#line hidden
#line 72
...
#line 74
 testRunner.And("user completes their Quote", ((string)(null)), table771, "And ");
#line hidden
#line 78
...
#line hidden
                ...
                table772.AddRow(new string[] {
                            ...
                            "Myself"});
#line 80
 testRunner.And("user fills out the Additional Information page:", ((string)(null)), table772, "And ");
#line hidden
#line 85
...
#line hidden
                ...
                table773.AddRow(new string[] {
                            ...
                            "Visa"});
#line 86
 testRunner.Then("user goes to purchase a plan using the following information:", ((string)(null)), table773, "Then ");
#line hidden
#line 89
