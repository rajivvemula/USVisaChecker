Feature: Generate_CA_MailSortingServices_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Mail Sorting Services successfully purchases a policy for FL
	Given user starts a quote with:
		| Industry              | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Mail Sorting Services | 2         | I Run My Business From Property I Own | Vehicles     | 32541    | CA  |
	...
	And user fills in the Introduction page with these values:
		...
		| 1900                  | Individual/Sole Proprietor | 4523 Olde Plantation Pl |          | Destin |                   | Yes             |
	...
	And user creates a driver with these values:
		...
		| Chris     | Rock     | FL      | 03/13/1986 |     |       |             |             | No       | A000214398764 |
		| Eric      | Smith    | FL      | 04/01/1988 |     |       |             |             | No       | A000214398761 |
		| Mike      | Jones    | FL      | 09/03/1989 |     |       |             |             | No       | A000214398760 |
	...
	And user enters contact information:
		...
		| First Name                      | Triston                 |
		| Last Name                       | Bendotti                |
		| Business Email                  | Mailsorter@yopmail.com  |
		| Business Phone                  | (555) 867-5309          |
		| Business Website                |                         |
		| Business has an account manager |                         |
		| Want Save Money                 | Yes                     |
		| Owner's First Name              | Mailsorter              |
		| Owner's Last Name               | Services                |
		| Owner's Address                 | 4523 Olde Plantation Pl |
		| Owner's Address 2               |                         |
		| Owner's Zip Code                | 32541                   |
		| Owner's City                    | Destin                  |
