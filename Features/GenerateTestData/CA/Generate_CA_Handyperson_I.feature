Feature: Generate_CA_Handyperson_I

Populate the system with testing data primarily base on most common policy types per book of business.

@Generate @CA
Scenario: Generate CA Handyperson successfully purchases a policy for TX
	Given user starts a quote with:
		| Industry                  | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Handyperson: With Framing | 2         | I Run My Business From Property I Own | Vehicles     | 78744    | CA  |
	...
	And user enters contact information:
		...
		| First Name                      | Mike                   |
		| Last Name                       | Smith                  |
		| Business Email                  | Handperson@yopmail.com |
		...
		| Owner's Address                 | 5706 Hammermill Run    |
		| Owner's Address 2               |                        |
		| Owner's Zip Code                | 78744                  |
		| Owner's City                    | Austin                 |
		| Owner's State                   | Texas                  |
