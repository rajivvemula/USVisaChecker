Feature: CA_TowingServices_I
Purpose: Purchase a CA policy in SC with one vehicle and no accidents/incidents.
State: SC
Number of Vehicles: 1
Number of Trailers: 0

@Issued @Regression @SC @CA @Transportation
Scenario: CA Towing Services Issued In South Carolina
