Feature: CA_RoadsideAssistance_I
Purpose: Purchase a CA policy in TX with one vehicle and no accidents/incidents.
State: TX
Number of Vehicles: 1
Number of Trailers: 0

@Issued @Regression @TX @CA @Transportation
Scenario: CA Roadside Assistance Issued In Texas
