Feature: CA_TruckingLongDistanceHaulingMorethan300_D

A short summary of the feature

@Transportation @Declined @Regression @TX @CA
Scenario: CA Trucking Long Distance Hauling More Than 300 Declined Invalid Vehicle To Insure
	Given user starts a quote with:
		| Industry                                             | Employees | Location                              | Own or Lease | ZIP Code | LOB |
		| Trucking: Long Distance Hauling: more than 300 miles | 2         | I Run My Business From Property I Own | Vehicles     | 77449    | CA  |
