...
namespace BiBerkLOB.Features.Unit.PL
{
    ...
    public partial class PL_GenerateProposalEmail_CopyrightFeature
    {
...
#line 1 "PL_GenerateProposalEmail_Copyright.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Unit/PL", "PL_GenerateProposalEmail_Copyright", "User Story 81904: Staging Regression | Create Test Case | PL | Generate Proposal " +
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "PL_GenerateProposalEmail_Copyright")))
            {
                global::BiBerkLOB.Features.Unit.PL.PL_GenerateProposalEmail_CopyrightFeature.FeatureSetup(null);
            }
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("PL_GenerateProposalEmail_Copyright")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "PL_GenerateProposalEmail_Copyright")]
        ...
        public void PL_GenerateProposalEmail_Copyright()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("PL_GenerateProposalEmail_Copyright", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
...
#line hidden
            ...
            else
            {
                ...
                table1278.AddRow(new string[] {
                            ...
                            "PL"});
#line 7
 testRunner.Given("user starts a quote with:", ((string)(null)), table1278, "Given ");
#line hidden
#line 10
...
#line hidden
                ...
                table1279.AddRow(new string[] {
                            ...
                            "No"});
#line 11
 testRunner.Then("user fills out A Quick Introduction page with these values:", ((string)(null)), table1279, "Then ");
#line hidden
#line 14
...
#line hidden
                ...
                table1280.AddRow(new string[] {
                            ...
                            "Outside"});
#line 15
 testRunner.Then("user fills out the PL Business Details page with these values:", ((string)(null)), table1280, "Then ");
#line hidden
#line 21
...
#line hidden
                ...
                table1281.AddRow(new string[] {
                            ...
                            "0"});
#line 22
 testRunner.Then("user fills out the PL Coverage Details page with these values:", ((string)(null)), table1281, "Then ");
#line hidden
                ...
                table1282.AddRow(new string[] {
                            ...
                            "No"});
#line 28
 testRunner.Then("user fills out the PL Your Services page", ((string)(null)), table1282, "Then ");
#line hidden
#line 31
...
#line hidden
                ...
                table1283.AddRow(new string[] {
                            ...
                            ""});
#line 32
 testRunner.Then("user fills out About You page with these values:", ((string)(null)), table1283, "Then ");
#line hidden
#line 44
...
#line hidden
                ...
                table1284.AddRow(new string[] {
                            ...
                            "$3,000,000"});
#line 45
 testRunner.Then("user adjusts their  -  quote with these values:", ((string)(null)), table1284, "Then ");
#line hidden
#line 50
