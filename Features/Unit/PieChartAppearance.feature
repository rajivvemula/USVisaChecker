Feature: PieChartAppearance
Verify the appearance of the pie chart page as you approach it with different keywords.
...
Scenario: WC, BOP and CA recommended only
...
#GL - Not Available
#CA - Not Available
Scenario: CA and GL Not Available
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry           | Employees | Location                              | Own or Lease       | ZIP Code |
...
Scenario: WC Available Not Recommended
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry | Employees | Location                              | Own or Lease       | ZIP Code |
...
#BP - Not Available
Scenario: PL Recommended, BP Not Available
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_1 Do Not Recommend BOP
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location                    | Own or Lease | ZIP Code |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_2 Do Not Recommend GL
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location   | Own or Lease | ZIP Code |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_3 Recommend GL, BOP Available Not Recommended
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location   | Own or Lease | ZIP Code |
		| <industry> | <emp>     | <location> | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_4 TEHOME Recommend BOP, GL Available Not Recommended
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location                         | Own or Lease | ZIP Code |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_4 TEJOBSITE Recommend BOP, GL Available Not Recommended
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location             | Own or Lease | ZIP Code |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_5 TEHOME BOP Not Available, GL Available Not Recommended because PL
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location                         | Client Home | Own or Lease | ZIP Code |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_6 TEJOBSITE Recommend BOP, GL Available Not Recommended
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location             | Own or Lease | ZIP Code |
		| <industry> | <emp>     | I Work at a Job Site | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_7 TEHOME Do Not Recommend BOP
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location                         | Client Home | Own or Lease | ZIP Code |
		| <industry> | <emp>     | I Run My Business Out of My Home | <home>      | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_7 TEJOBSITE Do Not Recommend BOP
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location             | Own or Lease | ZIP Code |
		| <industry> | <emp>     | I Work at a Job Site | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario Outline: BOP_GL_Rule_8 Recommend GL only
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location   | Own or Lease | ZIP Code |
		| <industry> | <emp>     | <location> | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario Outline: WC_Rule_1 WC available but not recommended based on industry
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location   | Own or Lease | ZIP Code |
		| <industry> | <emp>     | <location> | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario Outline: WC_Rule_2 WC available but not recommended based on subindustry
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location   | Client Home | Own or Lease | ZIP Code |
...
@Unit @Smoke @PieChart
Scenario Outline: Inventory or Stock
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location   | Own or Lease | ZIP Code |
		| <industry> | <emp>     | <location> | <ool>        | <zip>    |
...
@Unit @Smoke @PieChart
Scenario: Pie Chart _ Discontinued Industries
	Given user will land on path with recommendation view: Pie
...
@Unit @Smoke @PieChart
Scenario: Pie Chart _ Ineligible Industries For CA In NJ
	Given user will land on path with recommendation view: Pie
	And user starts a quote with:
		| Industry   | Employees | Location             | Own or Lease | ZIP Code |
